...
import {SafeAreaView, StyleSheet, Image, FlatList, TouchableOpacity, View, Text} from 'react-native';
...
const Home = ({navigation}) => {
    ...
    function getCategoryNameById(id) {
        let category = categories.filter(a => a.id);
        ...
        return (
            <View style={{flexDirection: 'row', height: 50}}>
                ...
                <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
                    <View style={{
                        width: '70%', height: '100%', backgroundColor: COLORS.lightGray3, alignItems: 'center',
            ...
            return (
                ...
                >
                    ...
                    <Text style={{
                        ...
                        color: (selectedCategory?.id == item.id) ? COLORS.white : COLORS.black, ...FONTS.body5,
                    }}>
                        {item.name}
                    </Text>
            ...
            <TouchableOpacity style={{marginBottom: SIZES.padding * 2}}
                ...
                <View style={{marginBottom: SIZES.padding}}>
                    ...
                    <View style={{
                        ...
                        alignItems: 'center',
                        justifyContent: 'center', ...styles.shadow,
                    }}>
